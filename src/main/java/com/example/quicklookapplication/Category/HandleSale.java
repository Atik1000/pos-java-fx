...
public class HandleSale implements Initializable {
    ...
    @FXML
    private TableColumn<Sale, String> tablePhoneNumber;
    @FXML
    ...
    public void showProducts() {
        ...
        this.tablePhoneNumber.setCellValueFactory(new PropertyValueFactory("PhoneNumber"));
    ...
    private void insertProduct() {
        String query = "INSERT INTO `sales`(`product_id`, `quantity`, `phone_number`) VALUES (" +
                "'" + productId.getText() + "','"
                + productQuantity.getText() + "','" + phoneNumber.getText() + "')";
    ...
    private void clearForm() {
        ...
        this.phoneNumber.setText((String) null);
    }
